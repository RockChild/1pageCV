...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CaBhwYsJ.mjs");
...
var manifest = {
	"2c4985e96c199268f7f639534cb5e8e31d6b19d43286bf77416413db60ffde26": {
		...
		importer: () => import("../__root-B_OrKlHc.mjs")
	},
	"bd0e437ec3b35a327525367761302eea6e652fa163dd69c091fadb970db70b08": {
		functionName: "getPublicCv_createServerFn_handler",
		importer: () => import("./server-ByW5eU47.mjs")
	},
	"cb351f0cd5f53b2b8f684afb8ad19bbe4e0a2bbc368433802cbf01c6c5afea47": {
		functionName: "getMyPublishedCv_createServerFn_handler",
		importer: () => import("./server-ByW5eU47.mjs")
	},
	"efd050cb7d6332875e71971d04d509d9868c02137666dc3a6c3759a2fb5606ba": {
		functionName: "publishMyCv_createServerFn_handler",
		importer: () => import("./server-ByW5eU47.mjs")
	}
};
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-K7g2SDbD.mjs").then((n) => n.t),
